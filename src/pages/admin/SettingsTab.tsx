    ...
    <div className="max-w-2xl space-y-8">
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <Input value={form.whatsapp_url || ""} onChange={(e) => handleChange("whatsapp_url", e.target.value)} placeholder="https://wa.me/1234567890" />
          <p className="text-xs text-muted-foreground">Format: https://wa.me/yourphonenumber</p>
        </div>
      </div>
